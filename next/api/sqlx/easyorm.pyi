...
class EasyORM:
    ...
    def __init__(self, engine: conn_t, table: Table, *args, **kwargs) -> None: ...
    ...
    def conv_schemas_to_columns(self, schemas: schemas_n_t, join: Optional[Join] = ...) -> List[Column]: ...
    ...
    def check_values_as_possible(self, target: List[Column], data: dict) -> bool: ...
...
def sqlx_easy_orm(engine: conn_t, table: Table) -> EasyORM: ...
