...
def sqlx_encypt_pass(context: str, salt: bytes = ...) -> str: ...
...
def sqlx_row_to_dict(table: sqlx.Table, row: Row, schemas: schemas_n_t) -> dict: ...
def sqlx_fetch_as_dict(engine: conn_t, table: sqlx.Table, stmt: stmt_t, schemas: schemas_n_t = ..., size: int = ...) -> drows_t: ...
...
def sqlx_dump_with_engine(engine: Engine, metadata: Optional[sqlx.MetaData] = ...) -> Optional[str]: ...
def sqlx_dump(bind: Union[Dialect, conn_t] = ..., metadata: Optional[sqlx.MetaData] = ...) -> Optional[str]: ...
def sqlx_get_columns_names(columns: columns_n_t) -> List[str]: ...
def sqlx_create_metadata() -> sqlx.MetaData: ...
